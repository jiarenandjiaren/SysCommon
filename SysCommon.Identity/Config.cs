...
namespace SysCommon.IdentityServer
{
     public static class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new[]
            {
                new ApiResource("SysCommonapi", "SysCommon.WebApi")
                {
        ...
        public static IEnumerable<Client> GetClients(bool isProduction)
        {
            ...
            if (isProduction)
            {
                host = "http://demo.SysCommon.me";  //切换为自己的服务器信息
            }
            return new[]
            {
                new Client
                {
                    ClientId = "SysCommon.WebApi",//客户端名称
                    ...
                    AllowedScopes = { "SysCommonapi" }
                },
                new Client
                {
                    ClientId = "SysCommon.Mvc",
                    ClientName = "开源版mvc认证",
