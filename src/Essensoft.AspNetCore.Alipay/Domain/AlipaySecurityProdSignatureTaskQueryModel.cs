...
namespace Essensoft.AspNetCore.Alipay.Domain
{
    ...
    public class AlipaySecurityProdSignatureTaskQueryModel : AlipayObject
    {
        ...
        /// <summary>
        /// 查询订单编号，参考alipay.security.prod.signature.task.Servicely接口返回的order_id。
        /// </summary>
        ...
        /// <summary>
        /// 查询的签约任务编号列表，JSONArray格式。参考alipay.security.prod.signature.task.Servicely返回的task_list对象中的task_id属性。支持查询1到多个任务结果，如果列表为空，则默认查询所有任务结果，如果与当前订单下的任务没有匹配，则不返回任何签约任务。
        /// </summary>
