...
namespace SysCommon.App
{
    ...
    /// 文件管理
    /// </summary>
    public class FileApp : BaseApp<UploadFile,SysCommonDBContext>
    {
        ...
        public FileApp(IOptions<AppSetting> setOptions, IUnitWork<SysCommonDBContext> unitWork, IRepository<UploadFile,SysCommonDBContext> repository,
