...
{
    public class OrgManagerApp : BaseTreeApp<Org,SysCommonDBContext>
    {
        ...
        public OrgManagerApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<Org,SysCommonDBContext> repository,IAuth auth, 
