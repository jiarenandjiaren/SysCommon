...
using SysCommon.Repository.QueryObj;
...
namespace SysCommon.App
{
    public class DbExtension
    {
        ...
        public DbExtension(SysCommonDBContext context, IOptions<AppSetting> appConfiguration)
        {
            _context = context;
        ...
        public List<KeyDescription> GetProperties(string moduleName)
        {
            ...
            const string domain = "SysCommon.repository.domain.";
