...
{
    public class BuilderTableColumnApp : BaseApp<BuilderTableColumn,SysCommonDBContext>
    {
        public BuilderTableColumnApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<BuilderTableColumn,SysCommonDBContext> repository,
