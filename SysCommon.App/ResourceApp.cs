...
namespace SysCommon.App
{
    ...
    /// 分类管理
    /// </summary>
    public class ResourceApp:BaseApp<Resource,SysCommonDBContext>
    {
        ...
        public ResourceApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<Resource,SysCommonDBContext> repository
