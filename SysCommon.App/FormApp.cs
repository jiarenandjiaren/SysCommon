...
{
    public class FormApp : BaseApp<Form,SysCommonDBContext>
    {
        private IAuth _auth;
        ...
        public FormApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<Form,SysCommonDBContext> repository,
