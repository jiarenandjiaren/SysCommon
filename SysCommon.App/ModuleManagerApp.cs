...
{
    public class ModuleManagerApp : BaseTreeApp<Module,SysCommonDBContext>
    {
        ...
        public ModuleManagerApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<Module,SysCommonDBContext> repository
