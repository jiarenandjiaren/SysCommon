...
{
    public class OpenJobApp : BaseApp<OpenJob, SysCommonDBContext>
    {
        ...
        public OpenJobApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<OpenJob,SysCommonDBContext> repository,
