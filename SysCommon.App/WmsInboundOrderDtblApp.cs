...
{
    public class WmsInboundOrderDtblApp : BaseApp<WmsInboundOrderDtbl,SysCommonDBContext>
    {
        ...
        public WmsInboundOrderDtblApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<WmsInboundOrderDtbl,SysCommonDBContext> repository,
