...
{
    public class RevelanceManagerApp : BaseApp<Relevance,SysCommonDBContext>
    {
        private readonly ILogger<RevelanceManagerApp> _logger;
        public RevelanceManagerApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<Relevance,SysCommonDBContext> repository, IAuth auth, ILogger<RevelanceManagerApp> logger) : base(unitWork,
            repository, auth)
        {
            _logger = logger;
        }
