...
// ***********************************************************************
// <copyright file="NormalAuthStrategy.cs" company="SysCommon.App">
...
namespace SysCommon.App
{
    ...
    /// 普通用户授权策略
    /// </summary>
    public class NormalAuthStrategy :BaseApp<User,SysCommonDBContext>, IAuthStrategy
    {
        ...
        public NormalAuthStrategy(IUnitWork<SysCommonDBContext> unitWork, IRepository<User,SysCommonDBContext> repository, DbExtension dbExtension) : base(unitWork, repository,null)
        {
