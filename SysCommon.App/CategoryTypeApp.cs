...
{
    public class CategoryTypeApp : BaseApp<CategoryType,SysCommonDBContext>
    {
        ...
        public CategoryTypeApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<CategoryType,SysCommonDBContext> repository,
