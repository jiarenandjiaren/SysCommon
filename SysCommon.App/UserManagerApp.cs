...
{
    public class UserManagerApp : BaseApp<User,SysCommonDBContext>
    {
        private RevelanceManagerApp _revelanceApp;
        private OrgManagerApp _orgManagerApp;
        
        public UserManagerApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<User,SysCommonDBContext> repository,
