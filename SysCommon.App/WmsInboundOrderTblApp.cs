...
{
    public class WmsInboundOrderTblApp : BaseApp<WmsInboundOrderTbl,SysCommonDBContext>
    {
        ...
        public WmsInboundOrderTblApp(IUnitWork<SysCommonDBContext> unitWork, IRepository<WmsInboundOrderTbl,SysCommonDBContext> repository,
