...
namespace SysCommon.App.Test
{
    public class TestBase
    {
        ...
        public void Init()
        {
           ...
           // 测试my sql
           serviceCollection.AddDbContext<SysCommonDBContext>(options =>
               options.UseMySql("server=127.0.0.1;user id=root;database=SysCommondb;password=000000"));

//            serviceCollection.AddDbContext<SysCommonDBContext>(options =>
//                options.UseSqlServer("Data Source=.;Initial Catalog=SysCommonDB;User=sa;Password=000000;Integrated Security=True"));
