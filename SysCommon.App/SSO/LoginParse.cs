...
namespace SysCommon.App.SSO
{
    public class LoginParse
    {
        ...
        public IRepository<User,SysCommonDBContext> _app;
        private ICacheContext _cacheContext;
        private AppInfoService _appInfoService;

        public LoginParse( AppInfoService infoService, ICacheContext cacheContext, IRepository<User,SysCommonDBContext> userApp)
        {
