layui.config({
    base: "/js/"
}).use(['form', 'vue', 'ztree', 'layer', 'utils', 'element', 'slimscroll', 'jquery', 'droptree', 'SysCommon', 'flow/gooflow', 'flowlayout'], function () {
    var form = layui.form, element = layui.element,
		layer = (top == undefined || top.layer === undefined )? layui.layer : top.layer,
        $ = layui.jquery;
    var SysCommon = layui.SysCommon;
    ...
    $.getJSON('/FlowInstances/get?id=' + id,
        function (data) {
            ...
            if (data.Result.FrmType == 0) {
	            ...
	            $("#frmPreview").html("复杂表单暂时只能在<a href='http://demo.SysCommon.me:1803'>企业版</a>查看，开源版预计会在以后的开源版本中发布");
            }
