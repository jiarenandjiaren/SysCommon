...
var getOidcCallbackPath = function getOidcCallbackPath(oidcConfig) {
  var routeBase = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/';

  var domainStartsAt = '://';
  var hostAndPath = oidcConfig.redirect_uri.substr(oidcConfig.redirect_uri.indexOf(domainStartsAt) + domainStartsAt.length);
...
var createStoreModule = (function (oidcSettings) {
  ...
  var oidcCallbackPath = getOidcCallbackPath(oidcConfig, storeSettings.routeBase || '/');
...
export { vuexOidcCreateUserManager, vuexOidcCreateStoreModule, vuexOidcCreateNuxtRouterMiddleware, vuexOidcCreateRouterMiddleware, vuexOidcProcessSilentSignInCallback, vuexOidcGetOidcCallbackPath, vuexOidcUtils, vuexDispatchCustomBrowserEvent };
