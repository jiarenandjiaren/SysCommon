...
{
    public class ModuleManagerApp :BaseService<Module>
    {
        ...
        {
            var moduleIds = UnitWork.Find<Relevance>(u => u.TopFirstId == roleId && u.TopKey == Define.ROLEMENU)
                .Select(u => u.TopFirstId);
